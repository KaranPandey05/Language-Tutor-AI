...
def start_conversation(prompt=None):
    ...
    while True:
        ...
        generate_response(phrase, 'Kajal', "You are an English language teacher.", response_label, user_input_label)
...
def gui_main():
    ...
    root = tk.Tk()
    root.title("Kajal the English Tutor")  # Modify the title here
    ...
    title_label = tk.Label(root, text="Kajal the English Tutor", font=('Helvetica', 20, 'bold'), fg='white', bg='#2C3E50')
