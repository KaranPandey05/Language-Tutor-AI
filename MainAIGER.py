...
def start_conversation(prompt=None):
    ...
    while True:
        ...
        generate_response(phrase, 'Daniel', "You are a German language tutor. You will teach the user German. Since the user is an english speaker, you should talk in english. Only talk in German when translating something.", response_label, user_input_label)
...
def gui_main():
    ...
    root = tk.Tk()
    root.title("Daniel the German Tutor")  # Modify the title here
    ...
    title_label = tk.Label(root, text="Daniel the German Tutor", font=('Helvetica', 20, 'bold'), fg='white', bg='#2C3E50')
